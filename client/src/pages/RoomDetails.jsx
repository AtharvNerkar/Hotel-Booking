    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          ...
          <p className="text-xs font-inter py-1.5 px-1.3 text-white bg-orange-500 rounded-full ">
            20% Off
          </p>
        </div>
        {/* Room Ratings */}
        ...
        >
          ...
          <button
            ...
            text-white rounded-md max-md:w-full max-ms:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer"
          >
            Check Availability
          </button>
        </form>
        ...
        <div className="max-w-3xl bordr-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            groups. The guests will be allocated the ground floor according to
            availability. You get a comfortable two bedroom apartment that has a
            true city feeling.
          </p>
          {/* Hosted By */}
